...
namespace Fasetto.Word.Core
{
    public class ApplicationViewModel : ViewModel
    {
        ...
        public bool SettingsMenuVisible
        {
            ...
            //    if (value)
                    // Reload settings
              //      BaseTaskManager.RunAndForget(ViewModelSettings.LoadAsync);
            }
        }
        ...
        public void GoToPage(ApplicationPage page, ViewModel viewModel = null)
        {
            ...
            SideMenuVisible = page == ApplicationPage.ChatPage;
